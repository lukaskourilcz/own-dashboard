...
- [ ] **Decide whether umyjemefasadu is client work** — the 2026-09-16 import marked it `work`, the kickoff left it `own`, and `projects.engagement` now decides. It is inactive, so it shows nowhere today; set Engagement to Freelance in the project form if it was a client job. [imp:1] [owner:me] [time:5m] [kind:decision]
