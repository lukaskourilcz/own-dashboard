...
- **Settings** — database-synchronized appearance, navigation, task density, CV links, active GitHub projects, integrations, notification controls, own-only exports, legacy archive download, and account controls.
