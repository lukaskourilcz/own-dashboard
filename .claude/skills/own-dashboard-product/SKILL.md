...
description: Implement or review OwnDashboard product workflows, navigation, domain behavior, Supabase relationships, invoices, integrations, or route-scoped data loading. Use for any change that can affect professional entities, owner privacy, Tugedr opportunities, project workspaces, financial calculations, exports, or retired personal scope.
---
...
5. Preserve static FX, project cost/cron estimates, Czech invoice math/VAT/QR/print, OAuth boundaries, deterministic PDF extraction, and the no-model-call boundary (`docs/ai-and-privacy.md`).
