...
export const subscriptionAllocations: SubscriptionAllocation[] = [
  { id: "sa1", user_id: UID, subscription_id: "s5", project_id: "proj-aifirst", share: 0.4, note: "", created_at: TS, updated_at: TS },
  { id: "sa2", user_id: UID, subscription_id: "s5", project_id: "proj-dashboard", share: 0.3, note: "", created_at: TS, updated_at: TS },
  { id: "sa3", user_id: UID, subscription_id: "s5", project_id: "proj-gym", share: 0.3, note: "", created_at: TS, updated_at: TS },
  { id: "sa4", user_id: UID, subscription_id: "s6", project_id: "proj-dashboard", share: 0.5, note: "", created_at: TS, updated_at: TS },
  { id: "sa5", user_id: UID, subscription_id: "s6", project_id: "proj-gym", share: 0.5, note: "", created_at: TS, updated_at: TS },
...
export const projects: Project[] = [
  ...
  },
  {
    ...
    name: "gym-plzen",
    slug: "gym-plzen",
    repo_full_name: "lukaskourilcz/gym-plzen",
    url: null,
    notes: "",
    color: null,
    sort_order: 6,
...
export const competitors: Competitor[] = [
  {
    id: "comp-1", user_id: UID, project_id: "proj-aifirst", name: "TLDR AI", url: "https://tldr.tech/ai",
...
export const aiLinks: AiLink[] = [
  ...
  { id: "al4", user_id: UID, category_id: "ac1", title: "Mobbin", url: "https://mobbin.com", description: "Screens and flows from real products for UI research.", pricing: "freemium", usefulness_rating: 4, rating_rationale: "Fast reference for table and settings patterns.", project_relevance: [{ repository: "own-dashboard", reason: "Ledger-style table patterns for Money and Projects." }, { repository: "design-lab", reason: "Carousel and cover layout references." }], record_type: "link", created_at: TS, updated_at: TS },
  { id: "al5", user_id: UID, category_id: "ac3", title: "Ship one KPI band per screen", url: "https://example.com/ideas/kpi-band", description: "Observed on operational dashboards: one compact band of measures above the table keeps the numbers scannable.", pricing: null, usefulness_rating: 5, rating_rationale: "Directly applicable to Money overview.", project_relevance: [{ repository: "own-dashboard", reason: "Development finance hero band." }], record_type: "idea", created_at: TS, updated_at: TS },
