const professionalEn = {
    ...
    projectReferencesDescription: "Links and ideas from the library this project used or plans to use.",
    connectReference: "Connect a link or idea",
    chooseReference: "Choose from the library",
    referenceLink: "Link",
    referenceIdea: "Idea",
    referenceStatus: "Status",
    referenceUsed: "Used",
    referencePlanned: "Planned",
    connectReferenceAction: "Connect",
    removeReference: "Remove",
    noReferences: "No links or ideas connected yet.",
    allReferencesConnected: "Every library record is already connected.",
    projectVideo: "Video",
...
export const professional: { en: ProfessionalStrings; cs: ProfessionalStrings } = {
  ...
  cs: {
    ...
    projectReferencesDescription: "Odkazy a nápady z knihovny, které projekt použil nebo plánuje použít.",
    connectReference: "Připojit odkaz nebo nápad",
    chooseReference: "Vybrat z knihovny",
    referenceLink: "Odkaz",
    referenceIdea: "Nápad",
    referenceStatus: "Stav",
    referenceUsed: "Použito",
    referencePlanned: "Plánováno",
    connectReferenceAction: "Připojit",
    removeReference: "Odebrat",
    noReferences: "Zatím žádné připojené odkazy ani nápady.",
    allReferencesConnected: "Všechny záznamy z knihovny už jsou připojené.",
    projectVideo: "Video",
