...
export const jobs: { en: JobsStrings; cs: JobsStrings } = {
  en: {
    ...
    contactMigrationPending:
      "Contact fields appear once supabase/migrations/20260917190000_job_application_contacts.sql has been applied.",
  ...
  cs: {
    ...
    contactMigrationPending:
      "Pole kontaktu se objeví, až bude nasazena migrace supabase/migrations/20260917190000_job_application_contacts.sql.",
