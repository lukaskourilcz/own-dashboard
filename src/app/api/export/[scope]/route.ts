...
const TABLES: Record<Exclude<Scope, "legacy" | "full">, string[]> = {
  ...
  knowledge: ["notes", "prompts", "ai_links", "ai_categories", "ai_link_projects", "shortcuts", "reference_rows", "repo_notes", "repo_links"],
  projects: ["projects", "project_costs", "crons", "todos", "notes", "prompts", "important_dates", "subscriptions", "transactions", "invoices", "ai_link_projects"],
  notes: ["notes"],
  prompts: ["prompts"],
