...
const TABLES: Record<Exclude<Scope, "legacy" | "full">, string[]> = {
  financial: ["accounts", "bank_connections", "transactions", "subscriptions", "invoices", "invoice_items", "invoice_settings", "project_costs", "spend_categories", "transaction_rules", "transaction_category_rules"],
