...
describe("summarizeDevFinance", () => {
  const projects = [
    project({ id: "dash", name: "OwnDashboard", scope: "project" }),
    project({ id: "gym", name: "gym-plzen", scope: "work" }),
    project({ id: "old", name: "old", scope: "other" }),
  ];
  const subscriptions = [
  ...
  it("excludes personal subscriptions and splits shared ones by share", () => {
    ...
    expect(summary.projectsMonthly).toBeCloseTo(10, 5);
    expect(summary.worksMonthly).toBeCloseTo(5, 5);
